...
def main():
    ...
    statsPath = "/home/data/corpora/MultiplexEmbeddingMatrixAndEmbeddings/2018_corpus_stats.pkl"
    dataPath = "/home/data/corpora/wikipedia/WIKI/Parsed_data/"
    ...
    train_data.load_pairs_counting("/home/data/corpora/MultiplexEmbeddingMatrixAndEmbeddings/PD_data/train_count_cv_" + num_cross + ".pkl")
    train_data.load_argument_sample_table("new_sample_table.p")

    test_data = DataLoader(dataPath)
    test_data.read_stats(statsPath)
    test_data.load_pairs_counting("/home/data/corpora/MultiplexEmbeddingMatrixAndEmbeddings/PD_data/test_count_cv_" + num_cross + ".pkl")
    test_data.load_argument_sample_table("new_sample_table.p")



    modelPath = "/home/data/corpora/Multi-Relational-Word-Embeddings-for-Selectional-Preference-Acquisition/relation_text_embedding/wiki2018_all_relation_word2vec.model"
